...
scaler=pickle.load(open("/Flask/ss.pkl",'rb'))
encoder1=pickle.load(open("/Flask/Time_Orderd.pkl",'rb'))
encoder2=pickle.load(open("/Flask/Time_Order_picked.pkl",'rb'))
encoder3=pickle.load(open("/Flask/Weatherconditions.pkl",'rb'))
encoder4=pickle.load(open("/Flask/Road_traffic_density.pkl",'rb'))
encoder5=pickle.load(open("/Flask/Type_of_order.pkl",'rb'))
encoder6=pickle.load(open("/Flask/Type_of_vehicle.pkl",'rb'))
encoder7=pickle.load(open("/Flask/Festival.pkl",'rb'))
encoder8=pickle.load(open("/Flask/City.pkl",'rb'))
app=Flask(__name__)
@app.route('/')
def welcome():
